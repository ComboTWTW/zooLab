...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        if (!menu) {
            ...
            navigate(`${location.pathname}?menu=products`, { replace: true });
        }
    }, []);
    ...
    return (
        <div className="w-full flex relative">
            {decodedToken !== null && (
                <div className="min-h-screen bg-[#212529] min-w-[15%] flex flex-col px-6 pt-4 tracking-wider">
                    ...
                    {/* Menu */}
                    <div className="flex flex-col mt-4 min-w-[80%] w-full h-full ">
                    ...
                    <button
                        className={`py-2 montserrat justify-self-end mb-16 px-2 flex items-center gap-2 text-white`}
